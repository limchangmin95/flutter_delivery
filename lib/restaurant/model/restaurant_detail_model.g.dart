...
RestaurantDetailModel _$RestaurantDetailModelFromJson(
    ...
    RestaurantDetailModel(
      ...
      products: (json['products'] as List<dynamic>)
          .map((e) =>
              RestauarantProductModel.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
RestauarantProductModel _$RestauarantProductModelFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$RestauarantProductModelToJson(
        RestauarantProductModel instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
